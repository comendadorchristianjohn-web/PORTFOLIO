    ...
    <section className="relative min-h-screen flex items-center justify-center pt-24 overflow-hidden bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-6 flex flex-col items-start text-left">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/5 border border-black/10 text-zinc-700 text-[10px] font-semibold uppercase tracking-wider mb-6">
          ...
          <TextType 
            ...
            as="h1" 
            className="text-5xl sm:text-7xl font-bold tracking-tight text-black mb-4 leading-none" 
            loop={false}
          />
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 text-zinc-500 hover:text-black transition-colors duration-300">
